...
const PAGE_PERMISSIONS = {
  ...
  [ROUTES.HEATMAP]: [ROLES.ADMIN, ROLES.TRAFFIC_OPERATOR, ROLES.VIEWER],
  [ROUTES.TRENDS]: [ROLES.ADMIN, ROLES.TRAFFIC_OPERATOR, ROLES.VIEWER],
  [ROUTES.RECOMMENDATIONS]: [ROLES.ADMIN, ROLES.TRAFFIC_OPERATOR, ROLES.VIEWER],
  [ROUTES.REPORTS]: [ROLES.ADMIN, ROLES.TRAFFIC_OPERATOR, ROLES.VIEWER],
